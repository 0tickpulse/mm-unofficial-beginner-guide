...
If you followed the previous page, you should have a terminal open in your server's folder.
However, you no longer need to use that terminal because VSCode has an integrated terminal built-in.
...
Find and Replace is a very handy feature that allows you to search for text in your file, and optionally replace it with something else.
...
<Quiz
    question="Which line has a comment?"
    answers={["1", "2", "3", "4"]}
    correctAnswer={2}
    explanation={
        <>
...
In this page, we learned about text editors, and how to set up Visual Studio Code.
We also learned about YAML, a file format that is used for configuration files.
Finally, we learned about some of the basic features of Visual Studio Code.
