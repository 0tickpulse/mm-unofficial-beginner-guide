...
- `amount=10` - This is the amount of particles to show.
...
## Putting it on the mob

Now that we have our skill, we need to put it on the mob. We do this by adding it to the mob's `Skills` list.
...
We're not done yet! Go to the next page to learn more about skills.
